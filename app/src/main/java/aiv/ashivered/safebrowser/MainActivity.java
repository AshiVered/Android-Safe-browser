...
public class MainActivity extends Activity { private final int STORAGE_PERMISSION_CODE = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Boolean photosInStart = sp.getBoolean("photos", false);
        ...
        if (photosInStart) {
            Toast.makeText(MainActivity.this, R.string.PhotosBlocked, Toast.LENGTH_LONG).show();
        } else if (!photosInStart) {
            Toast.makeText(MainActivity.this, R.string.PhotosNotBlocked, Toast.LENGTH_LONG).show();
        }
